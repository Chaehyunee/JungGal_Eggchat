...
root_dir = '/data/EggChat/kochat/demo'
...
DATA = {
    ...
    'food_feeling_data_dir': BASE['root_dir'] + "data{_}food_feeling_data.csv".format(_=_),  # 생성된 food_feeling 데이터 파일 경로


    'NER_categories': ['DATE', 'LOCATION', 'RESTAURANT', 'PLACE', 'FEELING', 'FOODNAME'],  # 사용자 정의 태그 #FEELING 추가 (22.04.09)
