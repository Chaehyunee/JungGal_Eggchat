...
@food_feeling
class GoodClassifier(TorchProcessor):
    ...
    def predict(self, sequence: Tensor) -> list:
        ...
        self._load_model(self.model, feeling='good')
        self.model.eval()
    ...
    def train_epoch(self, epoch: int) -> tuple:
        ...
        for feats, labels, labels_s, labels_t, labels_r, lengths in self.train_data:
            feats, labels = feats.to(self.device), labels_g.to(self.device)
    ...
    def test_epoch(self, epoch: int) -> tuple:
        """
